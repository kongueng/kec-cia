...
<head>
	...
	function drop(e){
		e.preventDefault();
		var t=e.dataTransfer.getData("Text"),n=document.getElementById(t).className;
		switch(n) {
			case "theory": case "misc":
				if(e.target.innerHTML==""){
					e.target.innerHTML='<span class="tt '+n+'">'+$("#"+t).html()+"</span>"
				}else{
					removal=e.target;
					parent=removal.parentNode;
					if(removal.nodeName=="SPAN"){
						$(removal).hide();
						$(parent).html('<span class="tt '+n+'">'+$("#"+t).html()+"</span>")
					}else{
						e.target.innerHTML='<span class="tt '+n+'">'+$("#"+t).html()+"</span>"
					}
				}break;
			case"practical":
				id=e.target.id;
				var r=parseInt(id.charAt(3));
				targetClass=e.target.className;
				switch(r){
					case 2: case 3: case 4:
						id2=$("#"+targetClass+"2").attr("colspan","3").html('<span class="tt '+n+'">'+$("#"+t).html()+"</span>");
						id3=$("#"+targetClass+"3").hide();id4=$("#"+targetClass+"4").hide();
						break;
					case 5:case 6:case 7:
						id5=$("#"+targetClass+"5").attr("colspan","3").html('<span class="tt '+n+'">'+$("#"+t).html()+"</span>");
						id6=$("#"+targetClass+"6").hide();
						id7=$("#"+targetClass+"7").hide();
					break
				}
			break
		}
	}</script><?php endif; ?><script>(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)})(window,document,'script','//www.google-analytics.com/analytics.js','ga');ga('create', 'UA-31570065-3', 'kec-cia.com');ga('send', 'pageview');</script>
</head>
<body>
	<div id="topbar">
